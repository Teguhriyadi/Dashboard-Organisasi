...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ URL::asset('template/images/img.jpg') }}" />
            ...
            <div class="card">
                <form method="POST">
                    ...
                    <div class="card-body">
                        <div class="image">
                            <center>
                                <img src="{{ URL::asset('template/images/img.jpg') }}"
                        ...
                        <div class="form-group pull-right mt-2 mb-2">
                            <a target="_blank" href="https://trackormawa.polindra.ac.id/lupa_password">
                                Lupa Password ?
                            </a>
                        </div>
                        <br>
